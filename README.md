...
|            |      웹      | 웹팩이란 무엇인지 설명하고,<br>vue 프로젝트에서는 웹팩 설정을 어떻게 하는 지 설명하시오. |  O   |  O   |      |
| **14주차** |   네트워크   |                     프록시란 무엇인가요?                     |      |  O   |      |
|            |      웹      |       V8 엔진과 Node.js에 대해 아는만큼 설명해주세요.        |      |  O   |      |
|            |      DB      |             트랜잭션 격리 수준에 대해 아시나요?              |      |  O   |      |
|            |   운영체제   | 다수의 프로세스나 스레드가 공유 자원에 동시에<br> 접근하는 것을 제어하는 방법을 설명해주세요. |      |  O   |      |
| **15주차** |   네트워크   |           로드 밸런싱에 대해 간단히 설명해주세요.            |      |      |      |
|            |      웹      | UI/UX의 개념을 간단히 설명하고, 진행했던 프로젝트에서 UI/UX를 향상하기 위해 노력했던 경험을 말씀해주세요. |      |      |      |
|            |     언어     |      자바스크립트의 호이스팅(Hoisting)이란 무엇인가요?       |      |      |      |
|            |   알고리즘   | Sorting Algorithm에서 stable 하다는 것은 무엇을 의미하나요?  |      |      |      |
